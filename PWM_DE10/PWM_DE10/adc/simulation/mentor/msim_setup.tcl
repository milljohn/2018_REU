...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/altera_merlin_traffic_limiter.sv"                     -work cpu_data_master_limiter     
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/altera_avalon_st_pipeline_base.v"                     -work cpu_data_master_limiter     
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/altera_merlin_slave_agent.sv"                         -work ADC_adc_slave_agent         
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/altera_merlin_burst_uncompressor.sv"                  -work ADC_adc_slave_agent         
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/altera_merlin_slave_translator.sv"                    -work ADC_adc_slave_translator    
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/altera_merlin_master_translator.sv"                   -work cpu_data_master_translator  
