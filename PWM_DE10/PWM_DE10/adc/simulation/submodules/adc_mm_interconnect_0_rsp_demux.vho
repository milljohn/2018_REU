...
--synthesis_resources = 
 ...
 ENTITY  adc_mm_interconnect_0_rsp_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END adc_mm_interconnect_0_rsp_demux;

 ARCHITECTURE RTL OF adc_mm_interconnect_0_rsp_demux IS
 ...
 END RTL; --adc_mm_interconnect_0_rsp_demux
