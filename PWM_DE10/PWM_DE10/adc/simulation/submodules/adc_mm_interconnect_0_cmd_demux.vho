...
--synthesis_resources = 
 ...
 ENTITY  adc_mm_interconnect_0_cmd_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 BEGIN
	...
	src0_channel <= ( "0" & "0" & "0" & "0");
	src0_data <= ( sink_data(88 DOWNTO 0));
	src0_endofpacket <= sink_endofpacket;
	src0_startofpacket <= sink_startofpacket;
	src0_valid <= (sink_valid(0) AND sink_channel(0));
	src1_channel <= ( "0" & "0" & "0" & "0");
	src1_data <= ( sink_data(88 DOWNTO 0));
	src1_endofpacket <= sink_endofpacket;
	src1_startofpacket <= sink_startofpacket;
	src1_valid <= (sink_valid(1) AND sink_channel(1));
	src2_channel <= ( "0" & "0" & "0" & "0");
	src2_data <= ( sink_data(88 DOWNTO 0));
	src2_endofpacket <= sink_endofpacket;
	src2_startofpacket <= sink_startofpacket;
	src2_valid <= (sink_valid(2) AND sink_channel(2));
	src3_channel <= ( "0" & "0" & "0" & "0");
	src3_data <= ( sink_data(88 DOWNTO 0));
 ...
 END RTL; --adc_mm_interconnect_0_cmd_demux
