...
entity adc_mm_interconnect_0 is
	port (
		...
		cpu_data_master_address                 : in  std_logic_vector(14 downto 0) := (others => '0'); --                   cpu_data_master.address
		...
		cpu_instruction_master_address          : in  std_logic_vector(14 downto 0) := (others => '0'); --            cpu_instruction_master.address
		cpu_instruction_master_waitrequest      : out std_logic;                                        --                                  .waitrequest
		cpu_instruction_master_read             : in  std_logic                     := '0';             --                                  .read
		cpu_instruction_master_readdata         : out std_logic_vector(31 downto 0);                    --                                  .readdata
		cpu_instruction_master_readdatavalid    : out std_logic;                                        --                                  .readdatavalid
		ADC_adc_slave_address                   : out std_logic_vector(2 downto 0);                     --                     ADC_adc_slave.address
		ADC_adc_slave_write                     : out std_logic;                                        --                                  .write
		ADC_adc_slave_read                      : out std_logic;                                        --                                  .read
		ADC_adc_slave_readdata                  : in  std_logic_vector(31 downto 0) := (others => '0'); --                                  .readdata
		ADC_adc_slave_writedata                 : out std_logic_vector(31 downto 0);                    --                                  .writedata
		ADC_adc_slave_waitrequest               : in  std_logic                     := '0';             --                                  .waitrequest
		...
		LEDs_s1_address                         : out std_logic_vector(1 downto 0);                     --                           LEDs_s1.address
		LEDs_s1_write                           : out std_logic;                                        --                                  .write
		LEDs_s1_readdata                        : in  std_logic_vector(31 downto 0) := (others => '0'); --                                  .readdata
		LEDs_s1_writedata                       : out std_logic_vector(31 downto 0);                    --                                  .writedata
		LEDs_s1_chipselect                      : out std_logic;                                        --                                  .chipselect
		onchip_mem_s1_address                   : out std_logic_vector(10 downto 0);                    --                     onchip_mem_s1.address
...
end entity adc_mm_interconnect_0;

architecture rtl of adc_mm_interconnect_0 is
	...
	component adc_mm_interconnect_0_ADC_adc_slave_agent_rsp_fifo is
		port (
			clk               : in  std_logic                     := 'X';             -- clk
			reset             : in  std_logic                     := 'X';             -- reset
	...
	end component adc_mm_interconnect_0_ADC_adc_slave_agent_rsp_fifo;

	component adc_mm_interconnect_0_router is
		port (
	...
	end component adc_mm_interconnect_0_router;

	component adc_mm_interconnect_0_router_002 is
		port (
			sink_ready         : out std_logic;                                        -- ready
			sink_valid         : in  std_logic                     := 'X';             -- valid
			sink_data          : in  std_logic_vector(88 downto 0) := (others => 'X'); -- data
	...
	end component adc_mm_interconnect_0_router_002;
	...
	component altera_merlin_traffic_limiter is
		...
		port (
			...
			cmd_sink_data          : in  std_logic_vector(88 downto 0) := (others => 'X'); -- data
			cmd_sink_channel       : in  std_logic_vector(3 downto 0)  := (others => 'X'); -- channel
			cmd_sink_startofpacket : in  std_logic                     := 'X';             -- startofpacket
			cmd_sink_endofpacket   : in  std_logic                     := 'X';             -- endofpacket
			cmd_src_ready          : in  std_logic                     := 'X';             -- ready
			cmd_src_data           : out std_logic_vector(88 downto 0);                    -- data
			...
			rsp_sink_data          : in  std_logic_vector(88 downto 0) := (others => 'X'); -- data
			rsp_sink_startofpacket : in  std_logic                     := 'X';             -- startofpacket
			rsp_sink_endofpacket   : in  std_logic                     := 'X';             -- endofpacket
			rsp_src_ready          : in  std_logic                     := 'X';             -- ready
			rsp_src_valid          : out std_logic;                                        -- valid
			rsp_src_data           : out std_logic_vector(88 downto 0);                    -- data
	...
	component adc_mm_interconnect_0_cmd_demux is
		port (
			clk                : in  std_logic                     := 'X';             -- clk
			reset              : in  std_logic                     := 'X';             -- reset
			sink_ready         : out std_logic;                                        -- ready
	...
	end component adc_mm_interconnect_0_cmd_demux;

	component adc_mm_interconnect_0_cmd_mux is
		port (
			clk                 : in  std_logic                     := 'X';             -- clk
			reset               : in  std_logic                     := 'X';             -- reset
			src_ready           : in  std_logic                     := 'X';             -- ready
	...
	end component adc_mm_interconnect_0_cmd_mux;

	component adc_mm_interconnect_0_rsp_demux is
		port (
			clk                : in  std_logic                     := 'X';             -- clk
			reset              : in  std_logic                     := 'X';             -- reset
			sink_ready         : out std_logic;                                        -- ready
	...
	end component adc_mm_interconnect_0_rsp_demux;

	component adc_mm_interconnect_0_rsp_mux is
		port (
			clk                 : in  std_logic                     := 'X';             -- clk
			reset               : in  std_logic                     := 'X';             -- reset
			src_ready           : in  std_logic                     := 'X';             -- ready
	...
	end component adc_mm_interconnect_0_rsp_mux;

	component adc_mm_interconnect_0_avalon_st_adapter is
		generic (
	...
	end component adc_mm_interconnect_0_avalon_st_adapter;

	component adc_mm_interconnect_0_adc_adc_slave_translator is
		generic (
	...
	end component adc_mm_interconnect_0_adc_adc_slave_translator;

	component adc_mm_interconnect_0_cpu_jtag_debug_module_translator is
		generic (
			AV_ADDRESS_W                   : integer := 30;
			AV_DATA_W                      : integer := 32;
			UAV_DATA_W                     : integer := 32;
	...
	end component adc_mm_interconnect_0_cpu_jtag_debug_module_translator;

	component adc_mm_interconnect_0_onchip_mem_s1_translator is
		generic (
			AV_ADDRESS_W                   : integer := 30;
			AV_DATA_W                      : integer := 32;
			UAV_DATA_W                     : integer := 32;
	...
	end component adc_mm_interconnect_0_onchip_mem_s1_translator;

	component adc_mm_interconnect_0_leds_s1_translator is
		generic (
			AV_ADDRESS_W                   : integer := 30;
			AV_DATA_W                      : integer := 32;
			UAV_DATA_W                     : integer := 32;
	...
	end component adc_mm_interconnect_0_leds_s1_translator;

	component adc_mm_interconnect_0_cpu_data_master_translator is
		generic (
	...
	end component adc_mm_interconnect_0_cpu_data_master_translator;

	component adc_mm_interconnect_0_cpu_instruction_master_translator is
		generic (
			AV_ADDRESS_W                : integer := 32;
			AV_DATA_W                   : integer := 32;
			AV_BURSTCOUNT_W             : integer := 4;
	...
	end component adc_mm_interconnect_0_cpu_instruction_master_translator;
	...
	signal cpu_data_master_translator_avalon_universal_master_0_address              : std_logic_vector(14 downto 0); -- cpu_data_master_translator:uav_address -> cpu_data_master_agent:av_address
	...
	signal cpu_instruction_master_translator_avalon_universal_master_0_address       : std_logic_vector(14 downto 0); -- cpu_instruction_master_translator:uav_address -> cpu_instruction_master_agent:av_address
	...
	signal adc_adc_slave_agent_m0_readdata                                           : std_logic_vector(31 downto 0); -- ADC_adc_slave_translator:uav_readdata -> ADC_adc_slave_agent:m0_readdata
	signal adc_adc_slave_agent_m0_waitrequest                                        : std_logic;                     -- ADC_adc_slave_translator:uav_waitrequest -> ADC_adc_slave_agent:m0_waitrequest
	signal adc_adc_slave_agent_m0_debugaccess                                        : std_logic;                     -- ADC_adc_slave_agent:m0_debugaccess -> ADC_adc_slave_translator:uav_debugaccess
	signal adc_adc_slave_agent_m0_address                                            : std_logic_vector(14 downto 0); -- ADC_adc_slave_agent:m0_address -> ADC_adc_slave_translator:uav_address
	signal adc_adc_slave_agent_m0_byteenable                                         : std_logic_vector(3 downto 0);  -- ADC_adc_slave_agent:m0_byteenable -> ADC_adc_slave_translator:uav_byteenable
	signal adc_adc_slave_agent_m0_read                                               : std_logic;                     -- ADC_adc_slave_agent:m0_read -> ADC_adc_slave_translator:uav_read
	signal adc_adc_slave_agent_m0_readdatavalid                                      : std_logic;                     -- ADC_adc_slave_translator:uav_readdatavalid -> ADC_adc_slave_agent:m0_readdatavalid
	signal adc_adc_slave_agent_m0_lock                                               : std_logic;                     -- ADC_adc_slave_agent:m0_lock -> ADC_adc_slave_translator:uav_lock
	signal adc_adc_slave_agent_m0_writedata                                          : std_logic_vector(31 downto 0); -- ADC_adc_slave_agent:m0_writedata -> ADC_adc_slave_translator:uav_writedata
	signal adc_adc_slave_agent_m0_write                                              : std_logic;                     -- ADC_adc_slave_agent:m0_write -> ADC_adc_slave_translator:uav_write
	signal adc_adc_slave_agent_m0_burstcount                                         : std_logic_vector(2 downto 0);  -- ADC_adc_slave_agent:m0_burstcount -> ADC_adc_slave_translator:uav_burstcount
	signal adc_adc_slave_agent_rf_source_valid                                       : std_logic;                     -- ADC_adc_slave_agent:rf_source_valid -> ADC_adc_slave_agent_rsp_fifo:in_valid
	signal adc_adc_slave_agent_rf_source_data                                        : std_logic_vector(89 downto 0); -- ADC_adc_slave_agent:rf_source_data -> ADC_adc_slave_agent_rsp_fifo:in_data
	signal adc_adc_slave_agent_rf_source_ready                                       : std_logic;                     -- ADC_adc_slave_agent_rsp_fifo:in_ready -> ADC_adc_slave_agent:rf_source_ready
	signal adc_adc_slave_agent_rf_source_startofpacket                               : std_logic;                     -- ADC_adc_slave_agent:rf_source_startofpacket -> ADC_adc_slave_agent_rsp_fifo:in_startofpacket
	signal adc_adc_slave_agent_rf_source_endofpacket                                 : std_logic;                     -- ADC_adc_slave_agent:rf_source_endofpacket -> ADC_adc_slave_agent_rsp_fifo:in_endofpacket
	signal adc_adc_slave_agent_rsp_fifo_out_valid                                    : std_logic;                     -- ADC_adc_slave_agent_rsp_fifo:out_valid -> ADC_adc_slave_agent:rf_sink_valid
	signal adc_adc_slave_agent_rsp_fifo_out_data                                     : std_logic_vector(89 downto 0); -- ADC_adc_slave_agent_rsp_fifo:out_data -> ADC_adc_slave_agent:rf_sink_data
	signal adc_adc_slave_agent_rsp_fifo_out_ready                                    : std_logic;                     -- ADC_adc_slave_agent:rf_sink_ready -> ADC_adc_slave_agent_rsp_fifo:out_ready
	signal adc_adc_slave_agent_rsp_fifo_out_startofpacket                            : std_logic;                     -- ADC_adc_slave_agent_rsp_fifo:out_startofpacket -> ADC_adc_slave_agent:rf_sink_startofpacket
	signal adc_adc_slave_agent_rsp_fifo_out_endofpacket                              : std_logic;                     -- ADC_adc_slave_agent_rsp_fifo:out_endofpacket -> ADC_adc_slave_agent:rf_sink_endofpacket
	signal cmd_mux_src_valid                                                         : std_logic;                     -- cmd_mux:src_valid -> ADC_adc_slave_agent:cp_valid
	signal cmd_mux_src_data                                                          : std_logic_vector(88 downto 0); -- cmd_mux:src_data -> ADC_adc_slave_agent:cp_data
	signal cmd_mux_src_ready                                                         : std_logic;                     -- ADC_adc_slave_agent:cp_ready -> cmd_mux:src_ready
	signal cmd_mux_src_channel                                                       : std_logic_vector(3 downto 0);  -- cmd_mux:src_channel -> ADC_adc_slave_agent:cp_channel
	signal cmd_mux_src_startofpacket                                                 : std_logic;                     -- cmd_mux:src_startofpacket -> ADC_adc_slave_agent:cp_startofpacket
	signal cmd_mux_src_endofpacket                                                   : std_logic;                     -- cmd_mux:src_endofpacket -> ADC_adc_slave_agent:cp_endofpacket
	...
	signal cpu_jtag_debug_module_agent_m0_address                                    : std_logic_vector(14 downto 0); -- cpu_jtag_debug_module_agent:m0_address -> cpu_jtag_debug_module_translator:uav_address
	...
	signal cpu_jtag_debug_module_agent_rf_source_data                                : std_logic_vector(89 downto 0); -- cpu_jtag_debug_module_agent:rf_source_data -> cpu_jtag_debug_module_agent_rsp_fifo:in_data
	...
	signal cpu_jtag_debug_module_agent_rsp_fifo_out_data                             : std_logic_vector(89 downto 0); -- cpu_jtag_debug_module_agent_rsp_fifo:out_data -> cpu_jtag_debug_module_agent:rf_sink_data
	...
	signal cmd_mux_001_src_valid                                                     : std_logic;                     -- cmd_mux_001:src_valid -> cpu_jtag_debug_module_agent:cp_valid
	signal cmd_mux_001_src_data                                                      : std_logic_vector(88 downto 0); -- cmd_mux_001:src_data -> cpu_jtag_debug_module_agent:cp_data
	signal cmd_mux_001_src_ready                                                     : std_logic;                     -- cpu_jtag_debug_module_agent:cp_ready -> cmd_mux_001:src_ready
	signal cmd_mux_001_src_channel                                                   : std_logic_vector(3 downto 0);  -- cmd_mux_001:src_channel -> cpu_jtag_debug_module_agent:cp_channel
	signal cmd_mux_001_src_startofpacket                                             : std_logic;                     -- cmd_mux_001:src_startofpacket -> cpu_jtag_debug_module_agent:cp_startofpacket
	signal cmd_mux_001_src_endofpacket                                               : std_logic;                     -- cmd_mux_001:src_endofpacket -> cpu_jtag_debug_module_agent:cp_endofpacket
	signal onchip_mem_s1_agent_m0_readdata                                           : std_logic_vector(31 downto 0); -- onchip_mem_s1_translator:uav_readdata -> onchip_mem_s1_agent:m0_readdata
	signal onchip_mem_s1_agent_m0_waitrequest                                        : std_logic;                     -- onchip_mem_s1_translator:uav_waitrequest -> onchip_mem_s1_agent:m0_waitrequest
	signal onchip_mem_s1_agent_m0_debugaccess                                        : std_logic;                     -- onchip_mem_s1_agent:m0_debugaccess -> onchip_mem_s1_translator:uav_debugaccess
	signal onchip_mem_s1_agent_m0_address                                            : std_logic_vector(14 downto 0); -- onchip_mem_s1_agent:m0_address -> onchip_mem_s1_translator:uav_address
	signal onchip_mem_s1_agent_m0_byteenable                                         : std_logic_vector(3 downto 0);  -- onchip_mem_s1_agent:m0_byteenable -> onchip_mem_s1_translator:uav_byteenable
	signal onchip_mem_s1_agent_m0_read                                               : std_logic;                     -- onchip_mem_s1_agent:m0_read -> onchip_mem_s1_translator:uav_read
	signal onchip_mem_s1_agent_m0_readdatavalid                                      : std_logic;                     -- onchip_mem_s1_translator:uav_readdatavalid -> onchip_mem_s1_agent:m0_readdatavalid
	signal onchip_mem_s1_agent_m0_lock                                               : std_logic;                     -- onchip_mem_s1_agent:m0_lock -> onchip_mem_s1_translator:uav_lock
	signal onchip_mem_s1_agent_m0_writedata                                          : std_logic_vector(31 downto 0); -- onchip_mem_s1_agent:m0_writedata -> onchip_mem_s1_translator:uav_writedata
	signal onchip_mem_s1_agent_m0_write                                              : std_logic;                     -- onchip_mem_s1_agent:m0_write -> onchip_mem_s1_translator:uav_write
	signal onchip_mem_s1_agent_m0_burstcount                                         : std_logic_vector(2 downto 0);  -- onchip_mem_s1_agent:m0_burstcount -> onchip_mem_s1_translator:uav_burstcount
	signal onchip_mem_s1_agent_rf_source_valid                                       : std_logic;                     -- onchip_mem_s1_agent:rf_source_valid -> onchip_mem_s1_agent_rsp_fifo:in_valid
	signal onchip_mem_s1_agent_rf_source_data                                        : std_logic_vector(89 downto 0); -- onchip_mem_s1_agent:rf_source_data -> onchip_mem_s1_agent_rsp_fifo:in_data
	signal onchip_mem_s1_agent_rf_source_ready                                       : std_logic;                     -- onchip_mem_s1_agent_rsp_fifo:in_ready -> onchip_mem_s1_agent:rf_source_ready
	signal onchip_mem_s1_agent_rf_source_startofpacket                               : std_logic;                     -- onchip_mem_s1_agent:rf_source_startofpacket -> onchip_mem_s1_agent_rsp_fifo:in_startofpacket
	signal onchip_mem_s1_agent_rf_source_endofpacket                                 : std_logic;                     -- onchip_mem_s1_agent:rf_source_endofpacket -> onchip_mem_s1_agent_rsp_fifo:in_endofpacket
	signal onchip_mem_s1_agent_rsp_fifo_out_valid                                    : std_logic;                     -- onchip_mem_s1_agent_rsp_fifo:out_valid -> onchip_mem_s1_agent:rf_sink_valid
	signal onchip_mem_s1_agent_rsp_fifo_out_data                                     : std_logic_vector(89 downto 0); -- onchip_mem_s1_agent_rsp_fifo:out_data -> onchip_mem_s1_agent:rf_sink_data
	signal onchip_mem_s1_agent_rsp_fifo_out_ready                                    : std_logic;                     -- onchip_mem_s1_agent:rf_sink_ready -> onchip_mem_s1_agent_rsp_fifo:out_ready
	signal onchip_mem_s1_agent_rsp_fifo_out_startofpacket                            : std_logic;                     -- onchip_mem_s1_agent_rsp_fifo:out_startofpacket -> onchip_mem_s1_agent:rf_sink_startofpacket
	signal onchip_mem_s1_agent_rsp_fifo_out_endofpacket                              : std_logic;                     -- onchip_mem_s1_agent_rsp_fifo:out_endofpacket -> onchip_mem_s1_agent:rf_sink_endofpacket
	signal cmd_mux_002_src_valid                                                     : std_logic;                     -- cmd_mux_002:src_valid -> onchip_mem_s1_agent:cp_valid
	signal cmd_mux_002_src_data                                                      : std_logic_vector(88 downto 0); -- cmd_mux_002:src_data -> onchip_mem_s1_agent:cp_data
	signal cmd_mux_002_src_ready                                                     : std_logic;                     -- onchip_mem_s1_agent:cp_ready -> cmd_mux_002:src_ready
	signal cmd_mux_002_src_channel                                                   : std_logic_vector(3 downto 0);  -- cmd_mux_002:src_channel -> onchip_mem_s1_agent:cp_channel
	signal cmd_mux_002_src_startofpacket                                             : std_logic;                     -- cmd_mux_002:src_startofpacket -> onchip_mem_s1_agent:cp_startofpacket
	signal cmd_mux_002_src_endofpacket                                               : std_logic;                     -- cmd_mux_002:src_endofpacket -> onchip_mem_s1_agent:cp_endofpacket
	signal leds_s1_agent_m0_readdata                                                 : std_logic_vector(31 downto 0); -- LEDs_s1_translator:uav_readdata -> LEDs_s1_agent:m0_readdata
	signal leds_s1_agent_m0_waitrequest                                              : std_logic;                     -- LEDs_s1_translator:uav_waitrequest -> LEDs_s1_agent:m0_waitrequest
	signal leds_s1_agent_m0_debugaccess                                              : std_logic;                     -- LEDs_s1_agent:m0_debugaccess -> LEDs_s1_translator:uav_debugaccess
	signal leds_s1_agent_m0_address                                                  : std_logic_vector(14 downto 0); -- LEDs_s1_agent:m0_address -> LEDs_s1_translator:uav_address
	signal leds_s1_agent_m0_byteenable                                               : std_logic_vector(3 downto 0);  -- LEDs_s1_agent:m0_byteenable -> LEDs_s1_translator:uav_byteenable
	signal leds_s1_agent_m0_read                                                     : std_logic;                     -- LEDs_s1_agent:m0_read -> LEDs_s1_translator:uav_read
	signal leds_s1_agent_m0_readdatavalid                                            : std_logic;                     -- LEDs_s1_translator:uav_readdatavalid -> LEDs_s1_agent:m0_readdatavalid
	signal leds_s1_agent_m0_lock                                                     : std_logic;                     -- LEDs_s1_agent:m0_lock -> LEDs_s1_translator:uav_lock
	signal leds_s1_agent_m0_writedata                                                : std_logic_vector(31 downto 0); -- LEDs_s1_agent:m0_writedata -> LEDs_s1_translator:uav_writedata
	signal leds_s1_agent_m0_write                                                    : std_logic;                     -- LEDs_s1_agent:m0_write -> LEDs_s1_translator:uav_write
	signal leds_s1_agent_m0_burstcount                                               : std_logic_vector(2 downto 0);  -- LEDs_s1_agent:m0_burstcount -> LEDs_s1_translator:uav_burstcount
	signal leds_s1_agent_rf_source_valid                                             : std_logic;                     -- LEDs_s1_agent:rf_source_valid -> LEDs_s1_agent_rsp_fifo:in_valid
	signal leds_s1_agent_rf_source_data                                              : std_logic_vector(89 downto 0); -- LEDs_s1_agent:rf_source_data -> LEDs_s1_agent_rsp_fifo:in_data
	signal leds_s1_agent_rf_source_ready                                             : std_logic;                     -- LEDs_s1_agent_rsp_fifo:in_ready -> LEDs_s1_agent:rf_source_ready
	signal leds_s1_agent_rf_source_startofpacket                                     : std_logic;                     -- LEDs_s1_agent:rf_source_startofpacket -> LEDs_s1_agent_rsp_fifo:in_startofpacket
	signal leds_s1_agent_rf_source_endofpacket                                       : std_logic;                     -- LEDs_s1_agent:rf_source_endofpacket -> LEDs_s1_agent_rsp_fifo:in_endofpacket
	signal leds_s1_agent_rsp_fifo_out_valid                                          : std_logic;                     -- LEDs_s1_agent_rsp_fifo:out_valid -> LEDs_s1_agent:rf_sink_valid
	signal leds_s1_agent_rsp_fifo_out_data                                           : std_logic_vector(89 downto 0); -- LEDs_s1_agent_rsp_fifo:out_data -> LEDs_s1_agent:rf_sink_data
	signal leds_s1_agent_rsp_fifo_out_ready                                          : std_logic;                     -- LEDs_s1_agent:rf_sink_ready -> LEDs_s1_agent_rsp_fifo:out_ready
	signal leds_s1_agent_rsp_fifo_out_startofpacket                                  : std_logic;                     -- LEDs_s1_agent_rsp_fifo:out_startofpacket -> LEDs_s1_agent:rf_sink_startofpacket
	signal leds_s1_agent_rsp_fifo_out_endofpacket                                    : std_logic;                     -- LEDs_s1_agent_rsp_fifo:out_endofpacket -> LEDs_s1_agent:rf_sink_endofpacket
	signal cmd_mux_003_src_valid                                                     : std_logic;                     -- cmd_mux_003:src_valid -> LEDs_s1_agent:cp_valid
	signal cmd_mux_003_src_data                                                      : std_logic_vector(88 downto 0); -- cmd_mux_003:src_data -> LEDs_s1_agent:cp_data
	signal cmd_mux_003_src_ready                                                     : std_logic;                     -- LEDs_s1_agent:cp_ready -> cmd_mux_003:src_ready
	signal cmd_mux_003_src_channel                                                   : std_logic_vector(3 downto 0);  -- cmd_mux_003:src_channel -> LEDs_s1_agent:cp_channel
	signal cmd_mux_003_src_startofpacket                                             : std_logic;                     -- cmd_mux_003:src_startofpacket -> LEDs_s1_agent:cp_startofpacket
	signal cmd_mux_003_src_endofpacket                                               : std_logic;                     -- cmd_mux_003:src_endofpacket -> LEDs_s1_agent:cp_endofpacket
	signal cpu_data_master_agent_cp_valid                                            : std_logic;                     -- cpu_data_master_agent:cp_valid -> router:sink_valid
	signal cpu_data_master_agent_cp_data                                             : std_logic_vector(88 downto 0); -- cpu_data_master_agent:cp_data -> router:sink_data
	...
	signal cpu_instruction_master_agent_cp_data                                      : std_logic_vector(88 downto 0); -- cpu_instruction_master_agent:cp_data -> router_001:sink_data
	...
	signal adc_adc_slave_agent_rp_valid                                              : std_logic;                     -- ADC_adc_slave_agent:rp_valid -> router_002:sink_valid
	signal adc_adc_slave_agent_rp_data                                               : std_logic_vector(88 downto 0); -- ADC_adc_slave_agent:rp_data -> router_002:sink_data
	signal adc_adc_slave_agent_rp_ready                                              : std_logic;                     -- router_002:sink_ready -> ADC_adc_slave_agent:rp_ready
	signal adc_adc_slave_agent_rp_startofpacket                                      : std_logic;                     -- ADC_adc_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	signal adc_adc_slave_agent_rp_endofpacket                                        : std_logic;                     -- ADC_adc_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	signal router_002_src_valid                                                      : std_logic;                     -- router_002:src_valid -> rsp_demux:sink_valid
	signal router_002_src_data                                                       : std_logic_vector(88 downto 0); -- router_002:src_data -> rsp_demux:sink_data
	...
	signal cpu_jtag_debug_module_agent_rp_valid                                      : std_logic;                     -- cpu_jtag_debug_module_agent:rp_valid -> router_003:sink_valid
	signal cpu_jtag_debug_module_agent_rp_data                                       : std_logic_vector(88 downto 0); -- cpu_jtag_debug_module_agent:rp_data -> router_003:sink_data
	signal cpu_jtag_debug_module_agent_rp_ready                                      : std_logic;                     -- router_003:sink_ready -> cpu_jtag_debug_module_agent:rp_ready
	signal cpu_jtag_debug_module_agent_rp_startofpacket                              : std_logic;                     -- cpu_jtag_debug_module_agent:rp_startofpacket -> router_003:sink_startofpacket
	signal cpu_jtag_debug_module_agent_rp_endofpacket                                : std_logic;                     -- cpu_jtag_debug_module_agent:rp_endofpacket -> router_003:sink_endofpacket
	signal router_003_src_valid                                                      : std_logic;                     -- router_003:src_valid -> rsp_demux_001:sink_valid
	signal router_003_src_data                                                       : std_logic_vector(88 downto 0); -- router_003:src_data -> rsp_demux_001:sink_data
	...
	signal onchip_mem_s1_agent_rp_valid                                              : std_logic;                     -- onchip_mem_s1_agent:rp_valid -> router_004:sink_valid
	signal onchip_mem_s1_agent_rp_data                                               : std_logic_vector(88 downto 0); -- onchip_mem_s1_agent:rp_data -> router_004:sink_data
	signal onchip_mem_s1_agent_rp_ready                                              : std_logic;                     -- router_004:sink_ready -> onchip_mem_s1_agent:rp_ready
	signal onchip_mem_s1_agent_rp_startofpacket                                      : std_logic;                     -- onchip_mem_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	signal onchip_mem_s1_agent_rp_endofpacket                                        : std_logic;                     -- onchip_mem_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	signal router_004_src_valid                                                      : std_logic;                     -- router_004:src_valid -> rsp_demux_002:sink_valid
	signal router_004_src_data                                                       : std_logic_vector(88 downto 0); -- router_004:src_data -> rsp_demux_002:sink_data
	...
	signal leds_s1_agent_rp_valid                                                    : std_logic;                     -- LEDs_s1_agent:rp_valid -> router_005:sink_valid
	signal leds_s1_agent_rp_data                                                     : std_logic_vector(88 downto 0); -- LEDs_s1_agent:rp_data -> router_005:sink_data
	signal leds_s1_agent_rp_ready                                                    : std_logic;                     -- router_005:sink_ready -> LEDs_s1_agent:rp_ready
	signal leds_s1_agent_rp_startofpacket                                            : std_logic;                     -- LEDs_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	signal leds_s1_agent_rp_endofpacket                                              : std_logic;                     -- LEDs_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	signal router_005_src_valid                                                      : std_logic;                     -- router_005:src_valid -> rsp_demux_003:sink_valid
	signal router_005_src_data                                                       : std_logic_vector(88 downto 0); -- router_005:src_data -> rsp_demux_003:sink_data
	...
	signal router_src_valid                                                          : std_logic;                     -- router:src_valid -> cpu_data_master_limiter:cmd_sink_valid
	signal router_src_data                                                           : std_logic_vector(88 downto 0); -- router:src_data -> cpu_data_master_limiter:cmd_sink_data
	signal router_src_ready                                                          : std_logic;                     -- cpu_data_master_limiter:cmd_sink_ready -> router:src_ready
	signal router_src_channel                                                        : std_logic_vector(3 downto 0);  -- router:src_channel -> cpu_data_master_limiter:cmd_sink_channel
	signal router_src_startofpacket                                                  : std_logic;                     -- router:src_startofpacket -> cpu_data_master_limiter:cmd_sink_startofpacket
	signal router_src_endofpacket                                                    : std_logic;                     -- router:src_endofpacket -> cpu_data_master_limiter:cmd_sink_endofpacket
	signal cpu_data_master_limiter_cmd_src_data                                      : std_logic_vector(88 downto 0); -- cpu_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	signal cpu_data_master_limiter_cmd_src_ready                                     : std_logic;                     -- cmd_demux:sink_ready -> cpu_data_master_limiter:cmd_src_ready
	signal cpu_data_master_limiter_cmd_src_channel                                   : std_logic_vector(3 downto 0);  -- cpu_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	signal cpu_data_master_limiter_cmd_src_startofpacket                             : std_logic;                     -- cpu_data_master_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	signal cpu_data_master_limiter_cmd_src_endofpacket                               : std_logic;                     -- cpu_data_master_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	signal rsp_mux_src_valid                                                         : std_logic;                     -- rsp_mux:src_valid -> cpu_data_master_limiter:rsp_sink_valid
	signal rsp_mux_src_data                                                          : std_logic_vector(88 downto 0); -- rsp_mux:src_data -> cpu_data_master_limiter:rsp_sink_data
	signal rsp_mux_src_ready                                                         : std_logic;                     -- cpu_data_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	signal rsp_mux_src_channel                                                       : std_logic_vector(3 downto 0);  -- rsp_mux:src_channel -> cpu_data_master_limiter:rsp_sink_channel
	signal rsp_mux_src_startofpacket                                                 : std_logic;                     -- rsp_mux:src_startofpacket -> cpu_data_master_limiter:rsp_sink_startofpacket
	signal rsp_mux_src_endofpacket                                                   : std_logic;                     -- rsp_mux:src_endofpacket -> cpu_data_master_limiter:rsp_sink_endofpacket
	signal cpu_data_master_limiter_rsp_src_valid                                     : std_logic;                     -- cpu_data_master_limiter:rsp_src_valid -> cpu_data_master_agent:rp_valid
	signal cpu_data_master_limiter_rsp_src_data                                      : std_logic_vector(88 downto 0); -- cpu_data_master_limiter:rsp_src_data -> cpu_data_master_agent:rp_data
	signal cpu_data_master_limiter_rsp_src_ready                                     : std_logic;                     -- cpu_data_master_agent:rp_ready -> cpu_data_master_limiter:rsp_src_ready
	signal cpu_data_master_limiter_rsp_src_channel                                   : std_logic_vector(3 downto 0);  -- cpu_data_master_limiter:rsp_src_channel -> cpu_data_master_agent:rp_channel
	signal cpu_data_master_limiter_rsp_src_startofpacket                             : std_logic;                     -- cpu_data_master_limiter:rsp_src_startofpacket -> cpu_data_master_agent:rp_startofpacket
	signal cpu_data_master_limiter_rsp_src_endofpacket                               : std_logic;                     -- cpu_data_master_limiter:rsp_src_endofpacket -> cpu_data_master_agent:rp_endofpacket
	signal router_001_src_valid                                                      : std_logic;                     -- router_001:src_valid -> cpu_instruction_master_limiter:cmd_sink_valid
	signal router_001_src_data                                                       : std_logic_vector(88 downto 0); -- router_001:src_data -> cpu_instruction_master_limiter:cmd_sink_data
	signal router_001_src_ready                                                      : std_logic;                     -- cpu_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	signal router_001_src_channel                                                    : std_logic_vector(3 downto 0);  -- router_001:src_channel -> cpu_instruction_master_limiter:cmd_sink_channel
	signal router_001_src_startofpacket                                              : std_logic;                     -- router_001:src_startofpacket -> cpu_instruction_master_limiter:cmd_sink_startofpacket
	signal router_001_src_endofpacket                                                : std_logic;                     -- router_001:src_endofpacket -> cpu_instruction_master_limiter:cmd_sink_endofpacket
	signal cpu_instruction_master_limiter_cmd_src_data                               : std_logic_vector(88 downto 0); -- cpu_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	signal cpu_instruction_master_limiter_cmd_src_ready                              : std_logic;                     -- cmd_demux_001:sink_ready -> cpu_instruction_master_limiter:cmd_src_ready
	signal cpu_instruction_master_limiter_cmd_src_channel                            : std_logic_vector(3 downto 0);  -- cpu_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	signal cpu_instruction_master_limiter_cmd_src_startofpacket                      : std_logic;                     -- cpu_instruction_master_limiter:cmd_src_startofpacket -> cmd_demux_001:sink_startofpacket
	signal cpu_instruction_master_limiter_cmd_src_endofpacket                        : std_logic;                     -- cpu_instruction_master_limiter:cmd_src_endofpacket -> cmd_demux_001:sink_endofpacket
	signal rsp_mux_001_src_valid                                                     : std_logic;                     -- rsp_mux_001:src_valid -> cpu_instruction_master_limiter:rsp_sink_valid
	signal rsp_mux_001_src_data                                                      : std_logic_vector(88 downto 0); -- rsp_mux_001:src_data -> cpu_instruction_master_limiter:rsp_sink_data
	signal rsp_mux_001_src_ready                                                     : std_logic;                     -- cpu_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	signal rsp_mux_001_src_channel                                                   : std_logic_vector(3 downto 0);  -- rsp_mux_001:src_channel -> cpu_instruction_master_limiter:rsp_sink_channel
	signal rsp_mux_001_src_startofpacket                                             : std_logic;                     -- rsp_mux_001:src_startofpacket -> cpu_instruction_master_limiter:rsp_sink_startofpacket
	signal rsp_mux_001_src_endofpacket                                               : std_logic;                     -- rsp_mux_001:src_endofpacket -> cpu_instruction_master_limiter:rsp_sink_endofpacket
	...
	signal cpu_instruction_master_limiter_rsp_src_data                               : std_logic_vector(88 downto 0); -- cpu_instruction_master_limiter:rsp_src_data -> cpu_instruction_master_agent:rp_data
	...
	signal cpu_instruction_master_limiter_rsp_src_channel                            : std_logic_vector(3 downto 0);  -- cpu_instruction_master_limiter:rsp_src_channel -> cpu_instruction_master_agent:rp_channel
	...
	signal cmd_demux_src0_data                                                       : std_logic_vector(88 downto 0); -- cmd_demux:src0_data -> cmd_mux:sink0_data
	...
	signal cmd_demux_src1_data                                                       : std_logic_vector(88 downto 0); -- cmd_demux:src1_data -> cmd_mux_001:sink0_data
	...
	signal cmd_demux_src2_data                                                       : std_logic_vector(88 downto 0); -- cmd_demux:src2_data -> cmd_mux_002:sink0_data
	...
	signal cmd_demux_src3_data                                                       : std_logic_vector(88 downto 0); -- cmd_demux:src3_data -> cmd_mux_003:sink0_data
	...
	signal cmd_demux_001_src0_data                                                   : std_logic_vector(88 downto 0); -- cmd_demux_001:src0_data -> cmd_mux:sink1_data
	...
	signal cmd_demux_001_src1_data                                                   : std_logic_vector(88 downto 0); -- cmd_demux_001:src1_data -> cmd_mux_001:sink1_data
	...
	signal cmd_demux_001_src2_data                                                   : std_logic_vector(88 downto 0); -- cmd_demux_001:src2_data -> cmd_mux_002:sink1_data
	...
	signal cmd_demux_001_src3_data                                                   : std_logic_vector(88 downto 0); -- cmd_demux_001:src3_data -> cmd_mux_003:sink1_data
	...
	signal rsp_demux_src0_data                                                       : std_logic_vector(88 downto 0); -- rsp_demux:src0_data -> rsp_mux:sink0_data
	...
	signal rsp_demux_src1_data                                                       : std_logic_vector(88 downto 0); -- rsp_demux:src1_data -> rsp_mux_001:sink0_data
	...
	signal rsp_demux_001_src0_data                                                   : std_logic_vector(88 downto 0); -- rsp_demux_001:src0_data -> rsp_mux:sink1_data
	...
	signal rsp_demux_001_src1_data                                                   : std_logic_vector(88 downto 0); -- rsp_demux_001:src1_data -> rsp_mux_001:sink1_data
	...
	signal rsp_demux_002_src0_data                                                   : std_logic_vector(88 downto 0); -- rsp_demux_002:src0_data -> rsp_mux:sink2_data
	...
	signal rsp_demux_002_src1_data                                                   : std_logic_vector(88 downto 0); -- rsp_demux_002:src1_data -> rsp_mux_001:sink2_data
	...
	signal rsp_demux_003_src0_data                                                   : std_logic_vector(88 downto 0); -- rsp_demux_003:src0_data -> rsp_mux:sink3_data
	...
	signal rsp_demux_003_src1_data                                                   : std_logic_vector(88 downto 0); -- rsp_demux_003:src1_data -> rsp_mux_001:sink3_data
	...
	signal cpu_data_master_limiter_cmd_valid_data                                    : std_logic_vector(3 downto 0);  -- cpu_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	signal cpu_instruction_master_limiter_cmd_valid_data                             : std_logic_vector(3 downto 0);  -- cpu_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	signal adc_adc_slave_agent_rdata_fifo_src_valid                                  : std_logic;                     -- ADC_adc_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	signal adc_adc_slave_agent_rdata_fifo_src_data                                   : std_logic_vector(33 downto 0); -- ADC_adc_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	signal adc_adc_slave_agent_rdata_fifo_src_ready                                  : std_logic;                     -- avalon_st_adapter:in_0_ready -> ADC_adc_slave_agent:rdata_fifo_src_ready
	signal avalon_st_adapter_out_0_valid                                             : std_logic;                     -- avalon_st_adapter:out_0_valid -> ADC_adc_slave_agent:rdata_fifo_sink_valid
	signal avalon_st_adapter_out_0_data                                              : std_logic_vector(33 downto 0); -- avalon_st_adapter:out_0_data -> ADC_adc_slave_agent:rdata_fifo_sink_data
	signal avalon_st_adapter_out_0_ready                                             : std_logic;                     -- ADC_adc_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	signal avalon_st_adapter_out_0_error                                             : std_logic_vector(0 downto 0);  -- avalon_st_adapter:out_0_error -> ADC_adc_slave_agent:rdata_fifo_sink_error
	signal cpu_jtag_debug_module_agent_rdata_fifo_src_valid                          : std_logic;                     -- cpu_jtag_debug_module_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	signal cpu_jtag_debug_module_agent_rdata_fifo_src_data                           : std_logic_vector(33 downto 0); -- cpu_jtag_debug_module_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	signal cpu_jtag_debug_module_agent_rdata_fifo_src_ready                          : std_logic;                     -- avalon_st_adapter_001:in_0_ready -> cpu_jtag_debug_module_agent:rdata_fifo_src_ready
	signal avalon_st_adapter_001_out_0_valid                                         : std_logic;                     -- avalon_st_adapter_001:out_0_valid -> cpu_jtag_debug_module_agent:rdata_fifo_sink_valid
	signal avalon_st_adapter_001_out_0_data                                          : std_logic_vector(33 downto 0); -- avalon_st_adapter_001:out_0_data -> cpu_jtag_debug_module_agent:rdata_fifo_sink_data
	signal avalon_st_adapter_001_out_0_ready                                         : std_logic;                     -- cpu_jtag_debug_module_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	signal avalon_st_adapter_001_out_0_error                                         : std_logic_vector(0 downto 0);  -- avalon_st_adapter_001:out_0_error -> cpu_jtag_debug_module_agent:rdata_fifo_sink_error
	signal onchip_mem_s1_agent_rdata_fifo_src_valid                                  : std_logic;                     -- onchip_mem_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	signal onchip_mem_s1_agent_rdata_fifo_src_data                                   : std_logic_vector(33 downto 0); -- onchip_mem_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	signal onchip_mem_s1_agent_rdata_fifo_src_ready                                  : std_logic;                     -- avalon_st_adapter_002:in_0_ready -> onchip_mem_s1_agent:rdata_fifo_src_ready
	signal avalon_st_adapter_002_out_0_valid                                         : std_logic;                     -- avalon_st_adapter_002:out_0_valid -> onchip_mem_s1_agent:rdata_fifo_sink_valid
	signal avalon_st_adapter_002_out_0_data                                          : std_logic_vector(33 downto 0); -- avalon_st_adapter_002:out_0_data -> onchip_mem_s1_agent:rdata_fifo_sink_data
	signal avalon_st_adapter_002_out_0_ready                                         : std_logic;                     -- onchip_mem_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	signal avalon_st_adapter_002_out_0_error                                         : std_logic_vector(0 downto 0);  -- avalon_st_adapter_002:out_0_error -> onchip_mem_s1_agent:rdata_fifo_sink_error
	signal leds_s1_agent_rdata_fifo_src_valid                                        : std_logic;                     -- LEDs_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	signal leds_s1_agent_rdata_fifo_src_data                                         : std_logic_vector(33 downto 0); -- LEDs_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	signal leds_s1_agent_rdata_fifo_src_ready                                        : std_logic;                     -- avalon_st_adapter_003:in_0_ready -> LEDs_s1_agent:rdata_fifo_src_ready
	signal avalon_st_adapter_003_out_0_valid                                         : std_logic;                     -- avalon_st_adapter_003:out_0_valid -> LEDs_s1_agent:rdata_fifo_sink_valid
	signal avalon_st_adapter_003_out_0_data                                          : std_logic_vector(33 downto 0); -- avalon_st_adapter_003:out_0_data -> LEDs_s1_agent:rdata_fifo_sink_data
	signal avalon_st_adapter_003_out_0_ready                                         : std_logic;                     -- LEDs_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	signal avalon_st_adapter_003_out_0_error                                         : std_logic_vector(0 downto 0);  -- avalon_st_adapter_003:out_0_error -> LEDs_s1_agent:rdata_fifo_sink_error

begin

	cpu_data_master_translator : component adc_mm_interconnect_0_cpu_data_master_translator
		generic map (
			AV_ADDRESS_W                => 15,
			AV_DATA_W                   => 32,
			AV_BURSTCOUNT_W             => 1,
	...
	cpu_instruction_master_translator : component adc_mm_interconnect_0_cpu_instruction_master_translator
		generic map (
			AV_ADDRESS_W                => 15,
			AV_DATA_W                   => 32,
			AV_BURSTCOUNT_W             => 1,
	...
	adc_adc_slave_translator : component adc_mm_interconnect_0_adc_adc_slave_translator
		generic map (
			AV_ADDRESS_W                   => 3,
			AV_DATA_W                      => 32,
			UAV_DATA_W                     => 32,
	...
	cpu_jtag_debug_module_translator : component adc_mm_interconnect_0_cpu_jtag_debug_module_translator
		generic map (
			AV_ADDRESS_W                   => 9,
			AV_DATA_W                      => 32,
			UAV_DATA_W                     => 32,
	...
	onchip_mem_s1_translator : component adc_mm_interconnect_0_onchip_mem_s1_translator
		generic map (
			AV_ADDRESS_W                   => 11,
			AV_DATA_W                      => 32,
			UAV_DATA_W                     => 32,
	...
	leds_s1_translator : component adc_mm_interconnect_0_leds_s1_translator
		generic map (
			AV_ADDRESS_W                   => 2,
			AV_DATA_W                      => 32,
			UAV_DATA_W                     => 32,
	...
	adc_adc_slave_agent : component altera_merlin_slave_agent
		generic map (
			PKT_ORI_BURST_SIZE_H      => 88,
			PKT_ORI_BURST_SIZE_L      => 86,
			PKT_RESPONSE_STATUS_H     => 85,
	...
	adc_adc_slave_agent_rsp_fifo : component adc_mm_interconnect_0_ADC_adc_slave_agent_rsp_fifo
		port map (
			clk               => clk_0_clk_clk,                                  --       clk.clk
			reset             => cpu_reset_n_reset_bridge_in_reset_reset,        -- clk_reset.reset
	...
	cpu_jtag_debug_module_agent : component altera_merlin_slave_agent
		generic map (
			PKT_ORI_BURST_SIZE_H      => 88,
			PKT_ORI_BURST_SIZE_L      => 86,
			PKT_RESPONSE_STATUS_H     => 85,
	...
	cpu_jtag_debug_module_agent_rsp_fifo : component adc_mm_interconnect_0_ADC_adc_slave_agent_rsp_fifo
		port map (
			clk               => clk_0_clk_clk,                                          --       clk.clk
			reset             => cpu_reset_n_reset_bridge_in_reset_reset,                -- clk_reset.reset
	...
	onchip_mem_s1_agent : component altera_merlin_slave_agent
		generic map (
			PKT_ORI_BURST_SIZE_H      => 88,
			PKT_ORI_BURST_SIZE_L      => 86,
			PKT_RESPONSE_STATUS_H     => 85,
	...
	onchip_mem_s1_agent_rsp_fifo : component adc_mm_interconnect_0_ADC_adc_slave_agent_rsp_fifo
		port map (
			clk               => clk_0_clk_clk,                                  --       clk.clk
			reset             => cpu_reset_n_reset_bridge_in_reset_reset,        -- clk_reset.reset
	...
	leds_s1_agent : component altera_merlin_slave_agent
		generic map (
			PKT_ORI_BURST_SIZE_H      => 88,
			PKT_ORI_BURST_SIZE_L      => 86,
			PKT_RESPONSE_STATUS_H     => 85,
	...
	leds_s1_agent_rsp_fifo : component adc_mm_interconnect_0_ADC_adc_slave_agent_rsp_fifo
		port map (
			clk               => clk_0_clk_clk,                            --       clk.clk
			reset             => cpu_reset_n_reset_bridge_in_reset_reset,  -- clk_reset.reset
	...
	router : component adc_mm_interconnect_0_router
		port map (
	...
	router_001 : component adc_mm_interconnect_0_router
		port map (
	...
	router_002 : component adc_mm_interconnect_0_router_002
		port map (
	...
	router_003 : component adc_mm_interconnect_0_router_002
		port map (
	...
	router_004 : component adc_mm_interconnect_0_router_002
		port map (
	...
	router_005 : component adc_mm_interconnect_0_router_002
		port map (
	...
	cpu_data_master_limiter : component altera_merlin_traffic_limiter
		generic map (
			PKT_DEST_ID_H             => 75,
			PKT_DEST_ID_L             => 74,
			PKT_SRC_ID_H              => 73,
	...
	cmd_demux : component adc_mm_interconnect_0_cmd_demux
		port map (
			clk                => clk_0_clk_clk,                                 --        clk.clk
			reset              => cpu_reset_n_reset_bridge_in_reset_reset,       --  clk_reset.reset
	...
	cmd_demux_001 : component adc_mm_interconnect_0_cmd_demux
		port map (
			clk                => clk_0_clk_clk,                                        --        clk.clk
			reset              => cpu_reset_n_reset_bridge_in_reset_reset,              --  clk_reset.reset
	...
	cmd_mux : component adc_mm_interconnect_0_cmd_mux
		port map (
			clk                 => clk_0_clk_clk,                           --       clk.clk
			reset               => cpu_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	cmd_mux_001 : component adc_mm_interconnect_0_cmd_mux
		port map (
			clk                 => clk_0_clk_clk,                           --       clk.clk
			reset               => cpu_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	cmd_mux_002 : component adc_mm_interconnect_0_cmd_mux
		port map (
			clk                 => clk_0_clk_clk,                           --       clk.clk
			reset               => cpu_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	cmd_mux_003 : component adc_mm_interconnect_0_cmd_mux
		port map (
			clk                 => clk_0_clk_clk,                           --       clk.clk
			reset               => cpu_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	rsp_demux : component adc_mm_interconnect_0_rsp_demux
		port map (
			clk                => clk_0_clk_clk,                           --       clk.clk
			reset              => cpu_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	rsp_demux_001 : component adc_mm_interconnect_0_rsp_demux
		port map (
			clk                => clk_0_clk_clk,                           --       clk.clk
			reset              => cpu_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	rsp_demux_002 : component adc_mm_interconnect_0_rsp_demux
		port map (
			clk                => clk_0_clk_clk,                           --       clk.clk
			reset              => cpu_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	rsp_demux_003 : component adc_mm_interconnect_0_rsp_demux
		port map (
			clk                => clk_0_clk_clk,                           --       clk.clk
			reset              => cpu_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	rsp_mux : component adc_mm_interconnect_0_rsp_mux
		port map (
			clk                 => clk_0_clk_clk,                           --       clk.clk
			reset               => cpu_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	rsp_mux_001 : component adc_mm_interconnect_0_rsp_mux
		port map (
			clk                 => clk_0_clk_clk,                           --       clk.clk
			reset               => cpu_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	avalon_st_adapter : component adc_mm_interconnect_0_avalon_st_adapter
		generic map (
			inBitsPerSymbol => 34,
			inUsePackets    => 0,
			inDataWidth     => 34,
	...
	avalon_st_adapter_001 : component adc_mm_interconnect_0_avalon_st_adapter
		generic map (
			inBitsPerSymbol => 34,
			inUsePackets    => 0,
			inDataWidth     => 34,
	...
	avalon_st_adapter_002 : component adc_mm_interconnect_0_avalon_st_adapter
		generic map (
			inBitsPerSymbol => 34,
			inUsePackets    => 0,
			inDataWidth     => 34,
	...
	avalon_st_adapter_003 : component adc_mm_interconnect_0_avalon_st_adapter
		generic map (
			inBitsPerSymbol => 34,
			inUsePackets    => 0,
			inDataWidth     => 34,
...
end architecture rtl; -- of adc_mm_interconnect_0
