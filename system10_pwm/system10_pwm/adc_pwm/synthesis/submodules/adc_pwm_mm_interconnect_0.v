...
`timescale 1 ps / 1 ps
module adc_pwm_mm_interconnect_0 (
		...
		output wire [0:0]  ADC_slave_address,                     //                       ADC_slave.address
		output wire        ADC_slave_write,                       //                                .write
		output wire        ADC_slave_read,                        //                                .read
		input  wire [15:0] ADC_slave_readdata,                    //                                .readdata
		output wire [15:0] ADC_slave_writedata,                   //                                .writedata
		output wire        ADC_slave_chipselect,                  //                                .chipselect
		...
		output wire [9:0]  onchip_mem_s1_address,                 //                   onchip_mem_s1.address
	...
	wire  [88:0] cpu_debug_mem_slave_agent_rf_source_data;                                  // cpu_debug_mem_slave_agent:rf_source_data -> cpu_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [88:0] cpu_debug_mem_slave_agent_rsp_fifo_out_data;                               // cpu_debug_mem_slave_agent_rsp_fifo:out_data -> cpu_debug_mem_slave_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> cpu_debug_mem_slave_agent:cp_data
	...
	wire  [13:0] onchip_mem_s1_agent_m0_address;                                            // onchip_mem_s1_agent:m0_address -> onchip_mem_s1_translator:uav_address
	...
	wire  [88:0] onchip_mem_s1_agent_rf_source_data;                                        // onchip_mem_s1_agent:rf_source_data -> onchip_mem_s1_agent_rsp_fifo:in_data
	...
	wire  [88:0] onchip_mem_s1_agent_rsp_fifo_out_data;                                     // onchip_mem_s1_agent_rsp_fifo:out_data -> onchip_mem_s1_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> onchip_mem_s1_agent:cp_data
	...
	wire  [88:0] leds_s1_agent_rf_source_data;                                              // LEDs_s1_agent:rf_source_data -> LEDs_s1_agent_rsp_fifo:in_data
	...
	wire  [88:0] leds_s1_agent_rsp_fifo_out_data;                                           // LEDs_s1_agent_rsp_fifo:out_data -> LEDs_s1_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> LEDs_s1_agent:cp_data
	...
	wire  [31:0] adc_slave_agent_m0_readdata;                                               // ADC_slave_translator:uav_readdata -> ADC_slave_agent:m0_readdata
	wire         adc_slave_agent_m0_waitrequest;                                            // ADC_slave_translator:uav_waitrequest -> ADC_slave_agent:m0_waitrequest
	wire         adc_slave_agent_m0_debugaccess;                                            // ADC_slave_agent:m0_debugaccess -> ADC_slave_translator:uav_debugaccess
	wire  [13:0] adc_slave_agent_m0_address;                                                // ADC_slave_agent:m0_address -> ADC_slave_translator:uav_address
	wire   [3:0] adc_slave_agent_m0_byteenable;                                             // ADC_slave_agent:m0_byteenable -> ADC_slave_translator:uav_byteenable
	wire         adc_slave_agent_m0_read;                                                   // ADC_slave_agent:m0_read -> ADC_slave_translator:uav_read
	wire         adc_slave_agent_m0_readdatavalid;                                          // ADC_slave_translator:uav_readdatavalid -> ADC_slave_agent:m0_readdatavalid
	wire         adc_slave_agent_m0_lock;                                                   // ADC_slave_agent:m0_lock -> ADC_slave_translator:uav_lock
	wire  [31:0] adc_slave_agent_m0_writedata;                                              // ADC_slave_agent:m0_writedata -> ADC_slave_translator:uav_writedata
	wire         adc_slave_agent_m0_write;                                                  // ADC_slave_agent:m0_write -> ADC_slave_translator:uav_write
	wire   [2:0] adc_slave_agent_m0_burstcount;                                             // ADC_slave_agent:m0_burstcount -> ADC_slave_translator:uav_burstcount
	wire         adc_slave_agent_rf_source_valid;                                           // ADC_slave_agent:rf_source_valid -> ADC_slave_agent_rsp_fifo:in_valid
	wire  [88:0] adc_slave_agent_rf_source_data;                                            // ADC_slave_agent:rf_source_data -> ADC_slave_agent_rsp_fifo:in_data
	wire         adc_slave_agent_rf_source_ready;                                           // ADC_slave_agent_rsp_fifo:in_ready -> ADC_slave_agent:rf_source_ready
	wire         adc_slave_agent_rf_source_startofpacket;                                   // ADC_slave_agent:rf_source_startofpacket -> ADC_slave_agent_rsp_fifo:in_startofpacket
	wire         adc_slave_agent_rf_source_endofpacket;                                     // ADC_slave_agent:rf_source_endofpacket -> ADC_slave_agent_rsp_fifo:in_endofpacket
	wire         adc_slave_agent_rsp_fifo_out_valid;                                        // ADC_slave_agent_rsp_fifo:out_valid -> ADC_slave_agent:rf_sink_valid
	wire  [88:0] adc_slave_agent_rsp_fifo_out_data;                                         // ADC_slave_agent_rsp_fifo:out_data -> ADC_slave_agent:rf_sink_data
	wire         adc_slave_agent_rsp_fifo_out_ready;                                        // ADC_slave_agent:rf_sink_ready -> ADC_slave_agent_rsp_fifo:out_ready
	wire         adc_slave_agent_rsp_fifo_out_startofpacket;                                // ADC_slave_agent_rsp_fifo:out_startofpacket -> ADC_slave_agent:rf_sink_startofpacket
	wire         adc_slave_agent_rsp_fifo_out_endofpacket;                                  // ADC_slave_agent_rsp_fifo:out_endofpacket -> ADC_slave_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                     // cmd_mux_003:src_valid -> ADC_slave_agent:cp_valid
	wire  [87:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> ADC_slave_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // ADC_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> ADC_slave_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                             // cmd_mux_003:src_startofpacket -> ADC_slave_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                               // cmd_mux_003:src_endofpacket -> ADC_slave_agent:cp_endofpacket
	wire         cpu_data_master_agent_cp_valid;                                            // cpu_data_master_agent:cp_valid -> router:sink_valid
	wire  [87:0] cpu_data_master_agent_cp_data;                                             // cpu_data_master_agent:cp_data -> router:sink_data
	...
	wire  [87:0] cpu_instruction_master_agent_cp_data;                                      // cpu_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [87:0] cpu_debug_mem_slave_agent_rp_data;                                         // cpu_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [87:0] onchip_mem_s1_agent_rp_data;                                               // onchip_mem_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [87:0] leds_s1_agent_rp_data;                                                     // LEDs_s1_agent:rp_data -> router_004:sink_data
	...
	wire         adc_slave_agent_rp_valid;                                                  // ADC_slave_agent:rp_valid -> router_005:sink_valid
	wire  [87:0] adc_slave_agent_rp_data;                                                   // ADC_slave_agent:rp_data -> router_005:sink_data
	wire         adc_slave_agent_rp_ready;                                                  // router_005:sink_ready -> ADC_slave_agent:rp_ready
	wire         adc_slave_agent_rp_startofpacket;                                          // ADC_slave_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         adc_slave_agent_rp_endofpacket;                                            // ADC_slave_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [87:0] router_src_data;                                                           // router:src_data -> cpu_data_master_limiter:cmd_sink_data
	...
	wire  [87:0] cpu_data_master_limiter_cmd_src_data;                                      // cpu_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [87:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> cpu_data_master_limiter:rsp_sink_data
	...
	wire  [87:0] cpu_data_master_limiter_rsp_src_data;                                      // cpu_data_master_limiter:rsp_src_data -> cpu_data_master_agent:rp_data
	...
	wire  [87:0] router_001_src_data;                                                       // router_001:src_data -> cpu_instruction_master_limiter:cmd_sink_data
	...
	wire  [87:0] cpu_instruction_master_limiter_cmd_src_data;                               // cpu_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [87:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> cpu_instruction_master_limiter:rsp_sink_data
	...
	wire  [87:0] cpu_instruction_master_limiter_rsp_src_data;                               // cpu_instruction_master_limiter:rsp_src_data -> cpu_instruction_master_agent:rp_data
	...
	wire         adc_slave_agent_rdata_fifo_src_valid;                                      // ADC_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] adc_slave_agent_rdata_fifo_src_data;                                       // ADC_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         adc_slave_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_003:in_0_ready -> ADC_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                         // avalon_st_adapter_003:out_0_valid -> ADC_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                          // avalon_st_adapter_003:out_0_data -> ADC_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                         // ADC_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                         // avalon_st_adapter_003:out_0_error -> ADC_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) adc_slave_translator (
		.clk                    (clk_clk_clk),                           //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (adc_slave_agent_m0_address),            // avalon_universal_slave_0.address
		.uav_burstcount         (adc_slave_agent_m0_burstcount),         //                         .burstcount
		.uav_read               (adc_slave_agent_m0_read),               //                         .read
		.uav_write              (adc_slave_agent_m0_write),              //                         .write
		.uav_waitrequest        (adc_slave_agent_m0_waitrequest),        //                         .waitrequest
		.uav_readdatavalid      (adc_slave_agent_m0_readdatavalid),      //                         .readdatavalid
		.uav_byteenable         (adc_slave_agent_m0_byteenable),         //                         .byteenable
		.uav_readdata           (adc_slave_agent_m0_readdata),           //                         .readdata
		.uav_writedata          (adc_slave_agent_m0_writedata),          //                         .writedata
		.uav_lock               (adc_slave_agent_m0_lock),               //                         .lock
		.uav_debugaccess        (adc_slave_agent_m0_debugaccess),        //                         .debugaccess
		.av_address             (ADC_slave_address),                     //      avalon_anti_slave_0.address
		.av_write               (ADC_slave_write),                       //                         .write
		.av_read                (ADC_slave_read),                        //                         .read
		.av_readdata            (ADC_slave_readdata),                    //                         .readdata
		.av_writedata           (ADC_slave_writedata),                   //                         .writedata
		.av_chipselect          (ADC_slave_chipselect),                  //                         .chipselect
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
		.av_byteenable          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_clk_clk),                                //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
		.m0_address              (adc_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (adc_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (adc_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (adc_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (adc_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (adc_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (adc_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (adc_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (adc_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (adc_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (adc_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (adc_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (adc_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (adc_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (adc_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (adc_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (adc_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (adc_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (adc_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (adc_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (adc_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (adc_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (adc_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (adc_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (adc_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (adc_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),          // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),          //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),           //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),          //                .error
		.rdata_fifo_src_ready    (adc_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (adc_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (adc_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                      //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                        //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) adc_slave_agent_rsp_fifo (
		.clk               (clk_clk_clk),                                //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.in_data           (adc_slave_agent_rf_source_data),             //        in.data
		.in_valid          (adc_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (adc_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (adc_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (adc_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (adc_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (adc_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (adc_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (adc_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (adc_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	adc_pwm_mm_interconnect_0_router router (
	...
	adc_pwm_mm_interconnect_0_router_001 router_001 (
	...
	adc_pwm_mm_interconnect_0_router_002 router_002 (
	...
	adc_pwm_mm_interconnect_0_router_002 router_003 (
	...
	adc_pwm_mm_interconnect_0_router_004 router_004 (
	...
	adc_pwm_mm_interconnect_0_router_004 router_005 (
		.sink_ready         (adc_slave_agent_rp_ready),              //      sink.ready
		.sink_valid         (adc_slave_agent_rp_valid),              //          .valid
		.sink_data          (adc_slave_agent_rp_data),               //          .data
		.sink_startofpacket (adc_slave_agent_rp_startofpacket),      //          .startofpacket
		.sink_endofpacket   (adc_slave_agent_rp_endofpacket),        //          .endofpacket
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_pwm_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                   //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	adc_pwm_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_clk_clk),                                          //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	adc_pwm_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_pwm_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_pwm_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_pwm_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_pwm_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_pwm_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_pwm_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_pwm_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_pwm_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_pwm_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	adc_pwm_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (adc_slave_agent_rdata_fifo_src_data),   //     in_0.data
		.in_0_valid     (adc_slave_agent_rdata_fifo_src_valid),  //         .valid
		.in_0_ready     (adc_slave_agent_rdata_fifo_src_ready),  //         .ready
